...
func JobsByStatusKey(prefix, status string) string       { return fmt.Sprintf("%s:jobs:by_status:%s", prefix, status) }
func JobsByTaskTypeKey(prefix, taskType string) string   { return fmt.Sprintf("%s:jobs:by_task_type:%s", prefix, taskType) }
func JobsByTagKey(prefix, tag string) string             { return fmt.Sprintf("%s:jobs:by_tag:%s", prefix, tag) }
func JobsByWorkflowKey(prefix, wfID string) string       { return fmt.Sprintf("%s:jobs:by_workflow:%s", prefix, wfID) }
func JobsByBatchKey(prefix, batchID string) string       { return fmt.Sprintf("%s:jobs:by_batch:%s", prefix, batchID) }
func UniqueKeyKey(prefix, uniqueKey string) string       { return fmt.Sprintf("%s:unique:%s", prefix, uniqueKey) }
...
func RunsByJobKey(prefix, jobID string) string        { return fmt.Sprintf("%s:runs:by_job:%s", prefix, jobID) }
func RunsActiveByJobKey(prefix, jobID string) string  { return fmt.Sprintf("%s:runs:active_by_job:%s", prefix, jobID) }

// Overlap buffer (schedule overlap policy)
func OverlapBufferedKey(prefix, jobID string) string   { return fmt.Sprintf("%s:overlap_buffered:%s", prefix, jobID) }
func OverlapBufferListKey(prefix, jobID string) string { return fmt.Sprintf("%s:overlap_buffer_list:%s", prefix, jobID) }
...
func WorkflowsByStatusKey(prefix, status string) string      { return fmt.Sprintf("%s:workflows:by_status:%s", prefix, status) }
...
func BatchesByStatusKey(prefix, status string) string       { return fmt.Sprintf("%s:batches:by_status:%s", prefix, status) }

// Batch Results
func BatchResultKey(prefix, batchID, itemID string) string  { return fmt.Sprintf("%s:batch_result:%s:%s", prefix, batchID, itemID) }
func BatchResultsSetKey(prefix, batchID string) string      { return fmt.Sprintf("%s:batch_results:%s", prefix, batchID) }
...
func WorkStreamKey(prefix, tierName string) string           { return fmt.Sprintf("%s:{%s}:work", prefix, tierName) }
func TiersKey(prefix string) string                         { return prefix + ":tiers" }
func DelayedKey(prefix, tierName string) string              { return fmt.Sprintf("%s:{%s}:delayed", prefix, tierName) }
...
func EventsBatchChannel(prefix, batchID string) string      { return fmt.Sprintf("%s:events:batch:%s", prefix, batchID) }

// Results
func ResultKey(prefix, jobID string) string                 { return fmt.Sprintf("%s:result:%s", prefix, jobID) }
func ResultNotifyChannel(prefix, jobID string) string       { return fmt.Sprintf("%s:result:notify:%s", prefix, jobID) }

// History
func HistoryRunsKey(prefix string) string                   { return prefix + ":history:runs" }
func HistoryRunKey(prefix, runID string) string             { return fmt.Sprintf("%s:history:run:%s", prefix, runID) }
func HistoryRunsByJobKey(prefix, jobID string) string       { return fmt.Sprintf("%s:history:runs:by_job:%s", prefix, jobID) }
func HistoryRunsByStatusKey(prefix, status string) string   { return fmt.Sprintf("%s:history:runs:by_status:%s", prefix, status) }
func HistoryEventsKey(prefix string) string                 { return prefix + ":history:events" }
func HistoryEventKey(prefix, eventID string) string         { return fmt.Sprintf("%s:history:event:%s", prefix, eventID) }
func HistoryEventsByJobKey(prefix, jobID string) string     { return fmt.Sprintf("%s:history:events:by_job:%s", prefix, jobID) }
func HistoryEventsByTypeKey(prefix, eventType string) string { return fmt.Sprintf("%s:history:events:by_type:%s", prefix, eventType) }
...
func RequestDedupKey(prefix, reqID string) string { return fmt.Sprintf("%s:reqdedup:%s", prefix, reqID) }

// Queue Pause (hash-tagged with tier for cluster slot co-location)
func QueuePausedKey(prefix, tierName string) string { return fmt.Sprintf("%s:{%s}:paused", prefix, tierName) }
...
func WorkflowEventsKey(prefix, wfID string) string { return fmt.Sprintf("%s:workflow:%s:events", prefix, wfID) }
